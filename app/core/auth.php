...
function loginUser($userId, $username, $role) {
    ...
    $_SESSION['role'] = $role; // legacy compatibility
...
// Get current user's dashboard URL based on role
function getCurrentUserDashboard() {
    $role = getCurrentUserRole();
    if (!$role) return '/dashboard.php';
    
    // Map roles to dashboard files
    $dashboards = [
        'admin' => '/app/views/dashboards/admin.php',
        'client' => '/app/views/dashboards/client.php',
        'project_manager' => '/app/views/dashboards/project_manager.php',
        'site_manager' => '/app/views/dashboards/site_manager.php',
        'site_engineer' => '/app/views/dashboards/site_engineer.php',
        'supervisor' => '/app/views/dashboards/supervisor.php',
        'sub_contractor' => '/app/views/dashboards/sub_contractor.php',
        'logistic_officer' => '/app/views/dashboards/logistic_officer.php',
        'finance' => '/app/views/dashboards/finance.php',
        'worker' => '/app/views/dashboards/worker.php',
        'supplier' => '/app/views/dashboards/supplier.php'
    ];
    ...
    if (isset($dashboards[$normalizedRole])) {
        return $dashboards[$normalizedRole];
    }
