            ...
            <tbody>
              <?php foreach ($projects as $project): ?>
                <tr>
                  ...
                  <td>
                    <?php $__appFolder = basename(BASE_PATH); ?>
                    <a class="btn btn-sm btn-info" href="/<?php echo $__appFolder; ?>/sub-contractor/project/<?php echo (int)$project['id']; ?>">
...
<script>
  $(document).ready(function() {
    $('#projectsTable').DataTable({ order: [[0,'desc']] });
  });

  // Snapshot modal & JS removed (direct navigation now used for full details)
</script>
