...
<body>
  ...
  <div class="col-md-9 col-lg-10 ms-sm-auto px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <a href="<?php echo url('/messages/project'); ?>" class="btn btn-sm btn-outline-secondary ms-2">Project Messages</a>
      </div>
    </div>
    ...
    <dialog id="composeDialog">
      <form method="dialog" id="composeForm">
        <h3>New Message</h3>
        <label>To
          <select id="composeToUserId" required>
            <option value="" disabled selected>Loading allowed recipients…</option>
          </select>
        </label>
        <label>Message
  ...
  <script src="<?= url('/assets/js/messages.js') ?>" defer></script>
  </body>
</html>